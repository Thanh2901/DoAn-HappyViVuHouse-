                        ...
                        <div className="card-body">
                            ...
                            <div className="row">
                                <div className="mb-3 col-md-6">
                                    ...
                                    {translate("rentaler:electric_and_water_management:last_month_water_usage_info")}
                                    </label>
                                    <input
                                    type="text"
                                    className="form-control"
                                ...
                                <div className="mb-3 col-md-6">
                                    ...
                                    {translate("rentaler:electric_and_water_management:this_month_water_usage_info")}
                                    </label>
                                    <input
                                    type="text"
                                    className="form-control"
                            ...
                            <div className="row">
                                ...
                                <div className="mb-3 col-md-6">
                                    <label className="form-label" htmlFor="paid">{translate("rentaler:electric_and_water_management:payStatus")}</label>
                                    <select className="form-select" id="paid" name="paid" value={electricData.paid} onChange={handleInputChange}>
                                        <option key={true} value={true}>{translate("rentaler:electric_and_water_management:paid")}</option>
                                        <option key={false} value={false}>{translate("rentaler:electric_and_water_management:unpaid")}</option>
                                    </select>
                                </div>
                            </div>
                                <div className='mb-3'>
                                    <label className="form-label" htmlFor="locationId">{translate("rentaler:electric_and_water_management:room")}</label>
                                ...
                                <button type="submit" className="btn btn-primary">{translate("rentaler:electric_and_water_management:submit")}</button>
                            </form>
                        </div>
                    </div>
                </div>
