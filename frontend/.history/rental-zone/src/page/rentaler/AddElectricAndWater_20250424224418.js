            ...
            <div className="container-fluid p-0">
              <div className="card">
                <div className="card-header">
                  <h5 className="card-title fs-5">Electric bill and water bill creation</h5>
                </div>
                <div className="card-body">
                  <form onSubmit={handleSubmit}>
                    {/* Bill Information Section */}
                    <div className="form-section border">
                      <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Thông tin hóa đơn</h6>
                      <div className="row">
                    ...
                    <div className="form-section border">
                      <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Thông tin sử dụng điện</h6>
                      <div className="row">
                    ...
                    {/* Water Usage Section */}
                    <div className="form-section border">
                      <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Thông tin sử dụng nước</h6>
                      <div className="row">
                        <div className="mb-3 col-md-4 col-sm-6">
                          <label className="form-label" htmlFor="lastMonthBlockOfWater">
                            Số khối nước tháng trước
                          </label>
                          <input
                              type="number"
                              className={`form-control compact-input ${
