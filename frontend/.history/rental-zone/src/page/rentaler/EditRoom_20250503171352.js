                            ...
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-section border p-3">
                                        <h6 className="text-capitalize fw-semibold bg-light p-2 rounded-2 mb-3">Basic information</h6>
                                        <div className="row">
                                    ...
                                    {/* Assets Section */}
                                    <div className="form-section border p-3">
                                        <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Assets information</h6>
                                        {roomData.assets?.map((asset, index) => (
                                            <div key={index} className="row">
                                                ...
                                                <div className="col-md-2 col-sm-2 mb-3">
                                                    <button type="button" className="btn btn-danger" onClick={() => handleRemoveAsset(index)}>Delete</button>
                                                </div>
                                            </div>
                                        ))}
                                        <button type="button" className="btn btn-primary" onClick={() => setRoomData(prevState => ({ ...prevState, assets: [...prevState.assets, { name: '', number: '' }] }))}>Add asset</button>
                                    </div>
