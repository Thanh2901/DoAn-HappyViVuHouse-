                            ...
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-section border p-3">
                                        <h6 className="text-capitalize fw-semibold bg-light p-2 rounded-2 mb-3">{translate("rentaler:rental_rooms_management:basicInfo")}</h6>
                                        <div className="row">
                                    ...
                                    <div className="form-section border p-3">
                                        <h6 className="text-capitalize fw-semibold bg-light p-2 rounded-2 mb-3">{translate("rentaler:rental_rooms_management:costInfo")}</h6>
                                        <div className="row">
                                    ...
                                    <div className="form-section border p-3">
                                        <h6 className="text-capitalize fw-semibold bg-light p-2 rounded-2 mb-3">{translate("rentaler:rental_rooms_management:locationInfo")}</h6>
                                        <div className="row">
                                            <div className="mb-3 col-md-4 col-sm-6">
                                            ...
                                            <div className="mb-3 col-md-4 col-sm-6">
                                                <label className="form-label" htmlFor="categoryId">{translate("rentaler:rental_rooms_management:area")}</label>
                                    ...
                                    {/* File Upload Section */}
                                    <div className="form-section border p-3">
                                        <h6 className="text-capitalize fw-semibold bg-light p-2 rounded-2 mb-3">{translate("rentaler:rental_rooms_management:image")}</h6>
                                        <div className="mb-3">
                                    ...
                                    {/* Assets Section */}
                                    <div className="form-section border p-3">
                                        <h6 className="text-capitalize fw-semibold bg-light p-2 rounded-2 mb-3">{translate("rentaler:rental_rooms_management:assetInfo")}</h6>
                                    ...
                                    <div className="form-buttons mt-2" style={{ display: "flex", gap: "1rem", justifyContent: "flex-end" }}>
                                        <button type="submit" className="btn btn-primary">{translate("rentaler:rental_rooms_management:update")}</button>
                                        <button
                                            type="button"
