        ...
        <div className="main">
          ...
          <div className="card">
            <div className="card-header">
              <h5 className="card-title fs-5">{translate("rentaler:maintenance_management:title")}</h5>
              <h6 className="card-subtitle text-muted">
                {" "}
                {translate("rentaler:maintenance_management:subtitle")}
              </h6>
            </div>
                  ...
                  <div className="col-sm-12 col-md-6">
                    <div className="dt-buttons btn-group flex-wrap">
                      <button
                        ...
                        type="button"
                      >
                        <a onClick={handleRedirectAddMaintenance}>
                        {translate("rentaler:maintenance_management:add_maintenance_ticket")}
                        </a>
                      </button>
                    </div>
                  </div>
                      ...
                      <thead>
                        <tr>
                          <th
                            ...
                            style={{ width: "224px" }}
                          >
                            {translate("rentaler:maintenance_management:room_name")}
                          </th>
                          <th
                            className="sorting"
                            tabindex="0"
                            ...
                            style={{ width: "180px" }}
                          >
                            {translate("rentaler:maintenance_management:address")}
                          </th>
                          <th
                            className="sorting"
                            tabindex="0"
                            ...
                            style={{ width: "166px" }}
                          >
                            {translate("rentaler:maintenance_management:maintenance_ticket")}
                          </th>
                          <th
                            className="sorting"
                            tabindex="0"
                          ...
                          >
                            {translate("rentaler:maintenance_management:cost")}
                          ...
                          >
                            {translate("rentaler:maintenance_management:time")}
                            <span className="sort-icon">
                              <i className="fas fa-sort-up"></i>
                              <i className="fas fa-sort-down"></i>
                            </span>
                          ...
                          <th
                            ...
                            style={{ width: "75px" }}
                          >
                            {translate("rentaler:maintenance_management:action")}
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                            ...
                            <td>
                              ...
                              >
                                <a
                                  ...
                                  target="_blank"
                                >
                                  {translate("rentaler:maintenance_management:watch")}
                                </a>
                              </button>
                            </td>
                            <td>
