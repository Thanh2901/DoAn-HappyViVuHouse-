...
import { getRentOfHome, getRentOfHomeForBill } from "../../services/fetch/ApiUtils";
                ...
                <div className="card-body">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-section border">
                      <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">{translate("rentaler:electric_and_water_management:billInfo")}</h6>
                      <div className="row">
                        ...
                        <div className="mb-3 col-md-6 col-sm-12">
                          ...
                          <select
                              ...
                              onChange={handleInputChange}
                          >
                            <option value="">{translate("rentaler:electric_and_water_management:chooseRoomPlaceholder")}...</option>
                      ...
                      <div className="row">
                        <div className="mb-3 col-md-6 col-sm-12">
                          ...
                          {translate("rentaler:electric_and_water_management:chooseRoom")}
                          </label>
                          <select
                    ...
                    <div className="form-section border">
                      <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">{translate("rentaler:electric_and_water_management:electric_bill_info")}</h6>
                      <div className="row">
                        <div className="mb-3 col-md-4 col-sm-6">
                          <label className="form-label" htmlFor="lastMonthNumberOfElectric">
                            {translate("rentaler:electric_and_water_management:last_month_electric_usage")}
                          </label>
                          <input
                              type="number"
                        ...
                        <div className="mb-3 col-md-4 col-sm-6">
                          <label className="form-label" htmlFor="thisMonthNumberOfElectric">
                            {translate("rentaler:electric_and_water_management:this_month_electric_usage")}
                          </label>
                          <input
                              type="number"
                              className={`form-control compact-input ${
                        ...
                        <div className="mb-3 col-md-4 col-sm-6">
                          <label className="form-label" htmlFor="moneyEachNumberOfElectric">
                            {translate("rentaler:electric_and_water_management:price_per_unit")}
                          </label>
                          <input
                              type="number"
                              className={`form-control compact-input ${
                    ...
                    {/* Water Usage Section */}
                    <div className="form-section border">
                      <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">{translate("rentaler:electric_and_water_management:water_bill_info")}</h6>
                      <div className="row">
                        <div className="mb-3 col-md-4 col-sm-6">
                          <label className="form-label" htmlFor="lastMonthBlockOfWater">
                            {translate("rentaler:electric_and_water_management:last_month_water_usage")}
                          </label>
                          <input
                              type="number"
                              className={`form-control compact-input ${
                        ...
                        <div className="mb-3 col-md-4 col-sm-6">
                          <label className="form-label" htmlFor="thisMonthBlockOfWater">
                            {translate("rentaler:electric_and_water_management:this_month_water_usage")}
                          </label>
                          <input
                              type="number"
                              className={`form-control compact-input ${
                    ...
                    <div className="form-buttons">
                      <button type="submit" className="btn btn-primary">
                        {translate("rentaler:electric_and_water_management:saveBill")}
                      </button>
                      <button
                          type="button"
                      ...
                      >
                        {translate("rentaler:electric_and_water_management:reset")}
                      </button>
                      <button
                          type="button"
                          className="btn btn-danger"
                          onClick={() => navigate("/rentaler/electric_water-management")}>
                            {translate("rentaler:electric_and_water_management:cancel")}
                      </button>
                    </div>
                  </form>
                </div>
