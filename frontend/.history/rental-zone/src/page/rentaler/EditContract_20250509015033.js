                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-3">
                                        <label className="form-label" htmlFor="locationId">{translate("rentaler:contracts_management:chooseRoom")}</label>
                                    ...
                                    <div className="mb-3">
                                        <label className="form-label" htmlFor="price">{translate("rentaler:contracts_management:contractDuration")}</label>
                                    ...
                                    <div className="row">
                                        <div className="mb-3">
                                            <label className="form-label">{translate("rentaler:contracts_management:uploadContract")}</label> <br />
                                            <h6 className="card-subtitle text-muted">{translate("rentaler:contracts_management:editNote")} <a href='https://image.luatvietnam.vn/uploaded/Others/2021/04/08/hop-dong-thue-nha-o_2810144434_2011152916_0804150405.doc'>Tải Mẫu</a></h6>

                                            {/* Hiển thị tệp hiện tại */}
                                            <div className="my-2">
                                                <h6>{translate("rentaler:contracts_management:currentContract")}:</h6>
                                                {currentFiles && currentFiles.length > 0 ? (
                                                    <button type="button" className="btn btn-outline-success" style={{marginBottom: "10px"}}>
                                                        ...
                                                        {translate("rentaler:contracts_management:watchContract")}
                                                        </a>
                                                    </button>
                                                ) : (
                                            ...
                                            {newFiles && newFiles.length > 0 && (
                                                <div className="mb-2">
                                                    <h6>{translate("rentaler:contracts_management:newContract")}:</h6>
                                                    <ul>
                                            ...
                                            <small className="form-text text-muted  mt-2">{translate("rentaler:contracts_management:editNote2")}</small>
                                        </div>
                                    </div>
                                    <button type="submit" className="btn btn-primary">{translate("rentaler:contracts_management:editNote2")}</button>
                                </form>
                            </div>
                        </div>
                    </div>
