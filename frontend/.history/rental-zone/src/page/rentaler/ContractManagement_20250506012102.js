                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          <th>{translate("rentaler:contracts_management:contract")}</th>
                          <th>{translate("rentaler:contracts_management:room_price")}</th>
                          <th>{translate("rentaler:contracts_management:additional_fee")}</th>
                          <th>{translate("rentaler:contracts_management:duration")}</th>
                          <th>
                            ...
                            <div className="filter-dropdown">
                              <ul className="dropdown-menu">
                                <li>
                                  <button
                                    className={`dropdown-item  ${filteredStatus === "all" ? "active" : ""}`}
                                    onClick={() => handleFilter("all")}
                                  >
                                    {translate("common:all") || "Tất cả"}
                                  </button>
                                </li>
                                <li>
                                  <button
                                    className={`dropdown-item  ${filteredStatus === "checked_out" ? "active" : ""}`}
                                ...
                                <li>
                                  <button
                                    className={`dropdown-item  ${filteredStatus === "hired" ? "active" : ""}`}
                                ...
                                <li>
                                  <button
                                    className={`dropdown-item  ${filteredStatus === "room_rent" ? "active" : ""}`}
                          ...
                          <th>{translate("rentaler:contracts_management:action")}</th>
                        </tr>
                        {/* <tr>
                          <th>{translate("rentaler:contracts_management:contract_name")}</th>
                          <th>{translate("rentaler:contracts_management:room_name")}</th>
                          <th>{translate("rentaler:contracts_management:tenants")}e</th>
                          <th>{translate("rentaler:contracts_management:phone_number")}</th>
                          <th>{translate("rentaler:contracts_management:contract")}</th>
                          <th>{translate("rentaler:contracts_management:room_price")}</th>
                          <th>{translate("rentaler:contracts_management:additional_fee")}</th>
