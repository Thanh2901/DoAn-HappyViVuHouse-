        ...
        <div className="main">
          ...
          <div className="card">
            <div className="card-header">
              <h5 className="card-title fs-5">{translate("rentaler:contracts_management:title")}</h5>
              <h6 className="card-subtitle text-muted">
                {" "}
                {translate("rentaler:contracts_management:subtitle")}
              </h6>
            </div>
                  ...
                  <div className="col-sm-12 col-md-6">
                    <div className="dt-buttons btn-group flex-wrap">
                      <button
                        ...
                        type="button"
                      >
                        <a onClick={handleRedirectAddRoom}>{translate("rentaler:contracts_management:add_contract")}</a>
                      </button>
                    </div>
                  </div>
                  <div className="col-sm-12 col-md-6">
                    ...
                    >
                      <label>
                        {translate("rentaler:search") || "Tìm kiếm"}:
                        <input
                          type="search"
                      ...
                      <thead>
                        <tr>
                          <th
                            ...
                            style={{ width: "224px" }}
                          >
                            {translate("rentaler:contracts_management:contract_name")}
                          </th>
                          <th
                            className="sorting sorting_asc"
                            tabindex="0"
                            ...
                            style={{ width: "224px" }}
                          >
                            {translate("rentaler:contracts_management:room_name")}
                          </th>
                          <th
                            className="sorting"
                            tabindex="0"
                            ...
                            style={{ width: "180px" }}
                          >
                            {translate("rentaler:contracts_management:tenants")}
                          </th>
                          <th
                            className="sorting"
                            tabindex="0"
                            ...
                            style={{ width: "180px" }}
                          >
                            {translate("rentaler:contracts_management:phone_number")}
                          </th>
                          <th
                            className="sorting"
                            tabindex="0"
                            ...
                            style={{ width: "150px" }}
                          >
                            {translate("rentaler:contracts_management:contract")}
                          </th>
                          <th
                            className="sorting"
                            tabindex="0"
                          ...
                          >
                            {translate("rentaler:contracts_management:room_price")}
                          ...
                          >
                            {translate("rentaler:contracts_management:additional_fee")}
                            <span className="sort-icon">
                              <i className="fas fa-sort-up"></i>
                              <i className="fas fa-sort-down"></i>
                            </span>
                          ...
                          >
                            {translate("rentaler:contracts_management:duration")}
                            <span className="sort-icon">
                              <i className="fas fa-sort-up"></i>
                              <i className="fas fa-sort-down"></i>
                            </span>
                          ...
                          <th
                            ...
                            style={{ width: "150px" }}
                          >
                            {translate("rentaler:contracts_management:status")}
                            ...
                            <div className="filter-dropdown">
                              <ul className="dropdown-menu">
                                <li>
                                  ...
                                  >
                                    {translate("rentaler:common:all") || "Tất cả"}
                                ...
                                <li>
                                  ...
                                  >
                                     {translate("rentaler:contracts_management:checked_out") || "Đã trả phòng"}
                                ...
                                <li>
                                  ...
                                  >
                                    {translate("rentaler:contracts_management:hired") || "Đã thuê"}
                                  </button>
                                </li>
                                <li>
                                  <button
                                  ...
                                  >
                                    {translate("rentaler:contracts_management:room_rent") || "Chưa thuê"}
                                  </button>
                                </li>
                              </ul>
                            </div>
                          ...
                          <th
                            ...
                            style={{ width: "134px" }}
                          >
                            {translate("rentaler:contracts_management:action") || "Hành động"}
                          </th>
                        </tr>
                      </thead>
                      <tbody>
                        {tableData.map((item) => (
                          <tr className="odd">
                            ...
                            <td>
                              ...
                              >
                                <a
                                  ...
                                  target="_blank"
                                >
                                  {translate("rentaler:contracts_management:watch")}
                                </a>
                              </button>
                            </td>
                            <td>
                            ...
                            <td>
                              {
                                calculateRemainingMonths(new Date(item.deadlineContract)) < 0
                                  ? <span style={{ color: "red" }}>Expiry</span>
                                  : `${calculateRemainingMonths(new Date(item.deadlineContract))} months`
                              }
                            </td>
                            <td style={{ color: "green" }}>
                              {item.room.status === "ROOM_RENT" ||
                              item.room.status === "CHECKED_OUT"
                                ? translate("rentaler:contracts_management:not_rented")
                                : translate("rentaler:contracts_management:rented")}
                            </td>
                            <td>
                              <a
                                href="#"
