...
function AddRoom(props) {
    ...
    const rooms = props.rooms || []; // <-- truyền rooms từ cha hoặc fetch
        ...
        validRooms.forEach((item) => {
            ...
            marker.bindPopup(
                `<b>${item.title}</b><br>${item.address || ""}<br>Giá: ${
                    ...
                    item.isApprove ? "<span style='color:green'>Đã duyệt</span>" : "<span style='color:red'>Chưa duyệt</span>"
                }`
            );
        });
                    ...
                    <div className="container-fluid p-0">
                        <div className="card">
                            <div className="card-header">
                                <h5 className="card-title fs-5">Room creation</h5>
                            </div>
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-buttons">
                                        <button type="submit" className="btn btn-primary">Post new feed</button>
                                        <button
                                            type="button"
