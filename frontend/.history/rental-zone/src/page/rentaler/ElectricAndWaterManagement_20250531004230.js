                      ...
                      <div className="col-sm-12">
                        ...
                        >
                          ...
                          <tr>
                            ...
                            <th>{translate("rentaler:electric_and_water_management:room_name")}</th>
                            <th>{translate("rentaler:electric_and_water_management:month")}</th>
                            <th>{translate("rentaler:electric_and_water_management:last_month_electric_usage")}</th>
                            <th>{translate("rentaler:electric_and_water_management:this_month_electric_usage")}</th>
                            <th>{translate("rentaler:electric_and_water_management:total_electricity_cost")}</th>
                            <th>{translate("rentaler:electric_and_water_management:last_month_water_usage")}</th>
                            <th>{translate("rentaler:electric_and_water_management:this_month_water_usage")}</th>
                            <th>{translate("rentaler:electric_and_water_management:total_water_cost")}</th>
                            <th>{translate("rentaler:electric_and_water_management:status")}</th>
                            <th>{translate("rentaler:electric_and_water_management:action")}</th>
                          </tr>
                          </thead>
                          <tbody>
                          {tableData.length === 0 ? (
                              ...
                              tableData.map((item) => (
                                  <tr key={item.id} className="odd">
                                    ...
                                    <td className="dtr-control sorting_1"> {item.month}
                                    </td>
