                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                ...
                                <thead>
                                <tr>
                                    <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "100px" }}>{translate("rentaler:rental_rooms_management:room_name")}</th>
                                    <th className="sorting" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "100px" }}>{translate("rentaler:rental_rooms_management:room_type")}</th>
                                    ...
                                    <th className="sorting" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "100px" }} >{translate("rentaler:rental_rooms_management:status")}</th>
                                ...
                                {filteredTableData.map((item) => (
                                    <tr className="odd">
                                        ...
                                        <td>{
                                            item.roomType === "REGULAR" ? <span className='bg-warning text-light p-1 rounded'>{translate("rentaler:rental_rooms_management:regular")}</span> : <span className='bg-primary text-light p-1 rounded'>{translate("rentaler:rental_rooms_management:vip")}</span>
                                        }
                                        </td>
                                        <td>{item.address}</td>
                                        <td><span className="bg-primary text-light p-1 rounded">
                                            {item.price && item.price.toLocaleString('vi-VN', {
                                            style: 'currency',
                                            currency: 'VND',
                                        })}
                                        </span></td>
                                        <td style={{ color: "green" }}>{item.status === "ROOM_RENT" || item.status === "CHECKED_OUT" ? translate("rentaler:contracts_management:not_rented") : translate("rentaler:contracts_management:rented")}</td>
