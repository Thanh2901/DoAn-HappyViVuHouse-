                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="form-section border">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="mb-3 col-md-4 col-sm-6">
                                                <label className="form-label" htmlFor="price">{translate("rentaler:maintenance_management:main")}</label>
                                                <input
                                                    type="number"
                                            ...
                                            <div className="mb-3 col-md-4 col-sm-6">
                                                <label className="form-label" htmlFor="maintenanceDate">Time</label>
                                                <input
                                                    type="datetime-local"
                                                    className="form-control compact-input"
                                                    id="maintenanceDate"
                                    ...
                                    {/* File Upload Section */}
                                    <div className="form-section border">
                                        <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Maintenance document</h6>
                                        <div className="mb-3">
                                            <label className="form-label">Upload ticket (PDF)</label>
                                            <input
