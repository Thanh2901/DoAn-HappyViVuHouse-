...
function DashboardRentaler(props) {
    ...
    const [subData, setSubData] = useState({
        ...
        datasets: [
          {
            label: translate("rentaler:statistics:revenue:title"),
            data: [],
            backgroundColor: [
              "rgba(75,192,192,1)",
              "#ecf0f1",
        ...
        getByMonth()
          .then((revenueData) => {
            setUserData((prevUserData) => ({
              ...prevUserData,
              labels: revenueData.content.filter((data) => data.month === monthOfNow).map((data) => translate("rentaler:statistics:revenue:month") + data.month),
              datasets: [
                {
            ...
            setSubData({
                ...
                labels: revenueData.content
                  ...
                  .map((data) => translate("rentaler:statistics:revenue:month") + " " + data.month),
                datasets: [
                    {
                        label: translate("rentaler:statistics:revenue:water_bill"),
                    ...
                    {
                        label: translate("rentaler:statistics:revenue:electric_bill"),
                    ...
                    {
                        label: translate("rentaler:statistics:revenue:internet_bill"),
