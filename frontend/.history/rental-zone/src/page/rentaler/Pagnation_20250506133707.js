                    ...
                    <div className="dataTables_paginate paging_simple_numbers" id="datatables-buttons_paginate">
                        <ul className="pagination">
                            ...
                            <li className=" next" id="datatables-buttons_next">
                                <a href="#" aria-controls="datatables-buttons" onClick={handleNext} aria-role="link" data-dt-idx="next" tabindex="0" className="page-link">{translate("rentaler:search:next")}</a>
                            </li>
                        </ul>
                    </div>
                </div>
