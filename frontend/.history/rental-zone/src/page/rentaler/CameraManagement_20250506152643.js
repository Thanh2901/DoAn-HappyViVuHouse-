          ...
          <div className="container-fluid p-0">
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center">
                <div>
                  <h5 className="card-title fs-3 mb-0">{translate("rentaler:camera_management:title")}</h5>
                  <h6 className="card-subtitle text-muted mt-3">
                    {translate("rentaler:camera_management:subtitle")}
                  </h6>
                </div>
                <button
                ...
                >
                  + {translate("rentaler:camera_management:add_camera")}
                </button>
              </div>
                              ...
                              <div className="card shadow-sm h-100">
                                ...
                                <div className="card-body">
                                  <div className="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span className="badge bg-primary p-2 text-dark">{cam.ip}:{cam.port}</span>
                                  </div>
                                  <div className="mb-2">
                                    <span className={`px-3 badge ${cameraStatus[cam.id] === true ? "bg-success" : "bg-danger"}`}>
                                      {cameraStatus[cam.id] === true ? translate("rentaler:camera_management:active") : translate("rentaler:camera_management:inactive")}
                                    </span>
                                  </div>
                                  <div className="d-flex justify-content-between">
                                    ...
                                    >
                                      <i className="bi bi-info-circle"></i> {translate("rentaler:camera_management:detail")}
                                    </button>
                                    <button
                                      className="btn btn-outline-warning btn-sm"
                                      onClick={() => handleEditCamera(cam.id)}
                                    >
                                      <i className="bi bi-pencil"></i> {translate("rentaler:camera_management:edit")}
                                    </button>
                                    <button
                                      className="btn btn-outline-danger btn-sm"
                                      onClick={() => handleDeleteCamera(cam.id)}
                                    >
                                      <i className="bi bi-trash"></i> {translate("rentaler:camera_management:delete")}
                                    </button>
                                  </div>
                                </div>
                              </div>
