            ...
            <div className="row">
                <div className="col-sm-12 col-md-5">
                    <div className="dataTables_info" id="datatables-buttons_info" role="status" aria-live="polite">
                        {translate("rentaler:pagination:firstPart")} {totalItems} {translate("rentaler:pagination:secondPart")}</div></div><div className="col-sm-12 col-md-7">
                    <div className="dataTables_paginate paging_simple_numbers" id="datatables-buttons_paginate">
                        <ul className="pagination">
                            <li className="previous" id="datatables-buttons_previous">
                                <a aria-controls="datatables-buttons" onClick={handlePrevious} aria-role="link" data-dt-idx="previous" tabindex="0" className="page-link">{translate("rentaler:pagination:previous")}</a>
                            </li>
                            ...
                            <li className=" next" id="datatables-buttons_next">
                                <a href="#" aria-controls="datatables-buttons" onClick={handleNext} aria-role="link" data-dt-idx="next" tabindex="0" className="page-link">{translate("rentaler:pagination:next")}</a>
                            </li>
                        </ul>
                    </div>
                </div>
