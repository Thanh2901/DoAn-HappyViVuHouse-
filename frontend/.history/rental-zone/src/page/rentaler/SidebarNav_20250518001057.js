    ...
    <ul className="sidebar-nav">
      ...
      <li className="sidebar-item">
        <NavLink to="/rentaler/room-management" className="sidebar-link">
          <i className="align-middle" data-feather="sliders"></i> <span className="align-middle">
            {translate("rentaler.sidebar.room_management")}
          </span>
        </NavLink>
      </li>
      <li className="sidebar-item">
      ...
      <li className="sidebar-item">
        <NavLink to="/rentaler/playback" className="sidebar-link">
          <i className="align-middle" data-feather="play-circle"></i> <span className="align-middle">Playback</span>
        </NavLink>
      </li>
      <li className="sidebar-item">
        <NavLink to="/rentaler/camera-management" className="sidebar-link">
          <i className="align-middle" data-feather="video"></i> <span className="align-middle">Camera</span>
        </NavLink>
      </li>
    </ul>
  )
