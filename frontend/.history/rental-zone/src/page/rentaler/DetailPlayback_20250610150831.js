...
function DetailPlayback(props) {
  ...
  useEffect(() => {
    if (selectedRecord && videoRef.current) {
      ...
      const videoUrl = selectedRecord.videoUrl || selectedRecord.url || selectedRecord.filePath || selectedRecord.path || selectedRecord.fileName || "";
      ...
      const possibleUrls = [
        videoUrl, // URL trực tiếp từ backend (đã bao gồm MinIO host)
        `${minioHost}/${videoUrl}`, // Nếu backend chỉ trả về path
                        ...
                        <div style={{ width: "100%", maxWidth: 800 }}>
                          ...
                          <div className="mt-2">
                            <small className="text-muted">
                              ...
                              VideoUrl: {selectedRecord.videoUrl || 'N/A'}<br/>
