...
const PlacesWithStandaloneSearchBox = ({ latLong }) => {
  const {
    ...
    apiKey: 'AlzaSyD7L7A81EJ_E3-iT0-srgna6QPRqSHuMsg',
    googleMapURL: `https://maps.googleapis.com/maps/api/js?key=AlzaSyD7L7A81EJ_E3-iT0-srgna6QPRqSHuMsg&v=3.exp&libraries=geometry,drawing,places`,
  });
