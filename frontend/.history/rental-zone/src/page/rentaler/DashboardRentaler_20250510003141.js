...
function DashboardRentaler(props) {
        ...
        getByMonth()
          .then((revenueData) => {
            setUserData((prevUserData) => ({
              ...prevUserData,
              labels: revenueData.content
                .filter((data) => data.month === monthOfNow)
                .map((data) => t("rentaler:statistics:revenue:month") + " " + data.month),
              datasets: [
                {
            ...
            setSubData((prevUserData) => ({
                ...
                datasets: [
                    {
                        label: t("rentaler:statistics:revenue:water_bill"),
                    ...
                    {
                        label: t("rentaler:statistics:revenue:electric_bill"),
                    ...
                    {
                        label: t("rentaler:statistics:revenue:internet_bill"),
    ...
    // Thêm i18n.language vào dependency để chạy lại khi đổi ngôn ngữ
    }, [i18n.language]);
...
useEffect(() => {
    // Giả sử bạn có dữ liệu costContent
    setCostData((prev) => ({
        ...prev,
        labels: /* ... */,
        datasets: [
            {
                ...prev.datasets[0],
                label: t("rentaler:statistics:revenue:cost_label"), // key trong file i18n
                data: /* ... */,
            }
        ]
    }));
}, [i18n.language, /* các dependency khác */]);

useEffect(() => {
    setCostData((prev) => ({
        ...prev,
        labels: [], // hoặc labels thực tế nếu có
        datasets: [
            {
                ...prev.datasets[0],
                label: t("rentaler:statistics:revenue:cost_label"),
                data: [], // hoặc data thực tế nếu có
            }
        ]
    }));
}, [i18n.language]);
                    ...
                    <div className="container-fluid p-0">
                        <div className="row mb-2 mb-xl-3">
                            <div className="col-auto d-none d-sm-block">
                                <h3><strong>✨</strong> {translate("rentaler:statistics:title")}</h3>
                            </div>
                        </div>
                        <div className="row">
                                    ...
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="col mt-0">
                                                <h5 className="card-title fs-6">{translate("rentaler:statistics:total_rooms")}</h5>
                                            </div>
                            ...
                            <div className="col-sm-6 col-xl-3">
                                <div className="card">
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="col mt-0">
                                                <h5 className="card-title fs-6">{translate("rentaler:statistics:number_of_tenants")}</h5>
                                            </div>
                            ...
                            <div className="col-sm-6 col-xl-3">
                                <div className="card">
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="col mt-0">
                                                <h5 className="card-title fs-6">{translate("rentaler:statistics:available_rooms")}</h5>
                                            </div>
                            ...
                            <div className="col-sm-6 col-xl-3">
                                <div className="card">
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="col mt-0">
                                                <h5 className="card-title fs-6">{translate("rentaler:statistics:revenue:title")}</h5>
                                            </div>
                            ...
                            <div className="col-12 col-lg-6 d-flex">
                                <div className="card flex-fill w-100">
                                    <div className="card-header">
                                        ...
                                        <h5 className="card-title mb-0 fs-6">{translate("rentaler:statistics:revenue:revenue_from_room_rental")}</h5>
                                    </div>
                            ...
                            <div className="col-12 col-lg-6 d-flex">
                                <div className="card flex-fill w-100">
                                    <div className="card-header">
                                        ...
                                        <h5 className="card-title mb-0 fs-6">{translate("rentaler:statistics:revenue:revenue_from_other_costs")}</h5>
                                    </div>
                                    <SubChart chartData={subData} options={{
                                        plugins: {
                                            title: {
                                                display: true,
                                                text: translate("rentaler:statistics:revenue:revenue_from_other_costs")
                                            },
                                            legend: {
                                                labels: {
                                                    // Chart.js v3+
