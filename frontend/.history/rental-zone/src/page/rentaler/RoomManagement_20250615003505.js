                            ...
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                ...
                                {filteredTableData.map((item) => (
                                    <tr className="odd">
                                        ...
                                        <td>{
                                            item.roomType === "REGULAR" ? <span className='bg-warning text-light p-1 rounded'>{translate("rentaler:rental_rooms_management:regular")}</span> : <span className='bg-danger text-light p-1 rounded'>{translate("rentaler:rental_rooms_management:vip")}</span>
                                        }
                                        </td>
                                        <td>{item.address}</td>
