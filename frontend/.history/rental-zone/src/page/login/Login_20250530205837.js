                        ...
                        <div className="col-md-6 contents">
                            <div className="row justify-content-center">
                                <div className="col-md-8">
                                    <div className="mb-4">
                                        <h3>Login to <a href="/" style={{ textDecoration: 'none' }}><span className="color-b">Happy ViVu</span> House</a></h3>
                                        <p className="mb-4">Don't have an account? <a href="/signup">Register a new account</a></p>
                                    </div>
                                    <LoginForm />
