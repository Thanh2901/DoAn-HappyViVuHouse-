...
const Chat = ({ authenticated, currentUser, onLogout, onNewMessage }) => {
    ...
    useEffect(() => {
    // ❌ Xóa phần reset khi currentUser thay đổi
    // vì có thể reset count không đúng lúc
    
    // ✅ Chỉ reset khi user thực sự logout/login
    if (currentUser) {
        console.log('👤 User logged in:', currentUser.name);
        // Không reset count ở đây trừ khi user thực sự mới login
    }
}, [currentUser]);
