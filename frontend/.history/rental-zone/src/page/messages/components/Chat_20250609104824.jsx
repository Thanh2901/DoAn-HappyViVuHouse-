...
const Chat = ({ authenticated, currentUser, onLogout, onNewMessage }) => {
    ...
    const [isReconnecting, setIsReconnecting] = useState(false); // Thêm state để track trạng thái reconnecting
    ...
    const reconnectTimeoutRef = useRef(null); // Thêm ref để quản lý timeout
    const autoReconnectOnFocusRef = useRef(true); // Flag để kiểm soát auto-reconnect
