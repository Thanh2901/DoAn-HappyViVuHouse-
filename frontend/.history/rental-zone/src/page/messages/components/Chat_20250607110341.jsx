            ...
            await new Promise((resolve, reject) => {
                tempClient.connect({}, () => {
                    ...
                    historySubscriptionRef.current = tempClient.subscribe('/topic/public/history', (message) => {
                        ...
                        setMessageCount(chatMessages.length); // Initialize message count from history
                        console.log(`Total messages received from history: ${chatMessages.length}`);
                ...
                subscriptionRef.current = client.subscribe('/topic/public', (message) => {
                    ...
                    if (messageWithId.type === 'JOIN' || messageWithId.type === 'LEAVE') {
                        ...
                        setMessages(prev => {
                            ...
                            setMessageCount(newMessages.length); // Update message count
                            console.log(`Total messages received: ${newMessages.length}`);
                            return newMessages;
                        });
