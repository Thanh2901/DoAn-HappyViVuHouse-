...
import NotificationSystem from '../components/NotificationSystem'; // Import component thông báo
                ...
                subscriptionRef.current = client.subscribe('/topic/public', (message) => {
                    ...
                    if (messageWithId.type === 'JOIN' || messageWithId.type === 'LEAVE') {
                        ...
                        setMessages(prev => {
                            ...
                            // Chỉ tăng message count nếu không phải tin nhắn của mình và window không được focus
                            if (!messageWithId.isOwnMessage && !isWindowFocused) {
                                dispatch(incrementMessageCount());
                                console.log(`Total new messages received: ${newMessageCount + 1}`);
                            }
