                        ...
                        <div className="row">
                            <div className="col-md-12 col-lg-8">
                                <div className="title-single-box">
                                    <h1 className="title-single">RENTAL ROOMS</h1>
                                    <span className="color-text-a">Find your ideal rental room</span>
                                </div>
                            </div>
                        ...
                        <div className="row" style={{ marginBottom: "30px" }}>
                            ...
                            <div className="col-sm-3">
                                <select className="form-select" id="categoryId" name="categoryId"
                                    ...
                                    <option value={2}>Rental Room</option>
                                    <option value={3}>Mini Apartment</option>
                                </select>
                            </div>
                        </div>
                        <div className="row">
                                                ...
                                                <div className="card-body-a">
                                                    <div className="price-box d-flex">
                                                        <span className="price-a">
                                                            {room.status === "ROOM_RENT" && `For rent |  ${room.price.toLocaleString('vi-VN', {
                                                                style: 'currency',
                                                                currency: 'VND',
                                                            })}`}
                                                            {room.status === "HIRED" && `Rented | ${room.price.toLocaleString('vi-VN', {
                                                                style: 'currency',
                                                                currency: 'VND',
                                                            })}`}
                                                            {room.status === "CHECKED_OUT" && `Checked out | ${room.price.toLocaleString('vi-VN', {
                                                                style: 'currency',
                                                                currency: 'VND',
                                                            })}`}
                                                        </span>
                                                    </div>
                                                    <Link to={`/rental-home/${room.id}`}>View details
