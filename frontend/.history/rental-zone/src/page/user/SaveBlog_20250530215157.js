                                                ...
                                                <div className="row g-0">
                                                    ...
                                                    <div className="col-12">
                                                        <div className="card-body py-3">
                                                            <h5 className="card-title mb-2 text-primary" style={{ fontSize: "15px" }}>
                                                            ...
                                                            <div className="mb-2">
                                                                ...
                                                                {item.room.status === "ROOM_RENT" && <span className="badge bg-success">For rent</span>}
                                                                {item.room.status === "HIRED" && <span className="badge bg-warning text-dark">Rented</span>}
                                                                {item.room.status === "CHECKED_OUT" && <span className="badge bg-secondary">Checked out</span>}
                                                            </div>
                                                            <div className="mb-2">
                                                                <strong>Price:</strong>{" "}
                                                            ...
                                                            <Link to={`/rental-home/${item.room.id}`} className="btn btn-outline-primary btn-sm mt-2 w-100">
                                                                View details
                                                            </Link>
                                                        </div>
                                                    </div>
