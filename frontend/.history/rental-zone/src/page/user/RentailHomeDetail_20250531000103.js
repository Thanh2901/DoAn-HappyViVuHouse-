                            ...
                            <div class="row">
                                            ...
                                            <div class="property-price d-flex justify-content-center foo">
                                                <div class="card-header-c d-flex">
                                                    ...
                                                    <div class="card-title-c align-self-center">
                                                        <h5 class="title-c">{rooms ? rooms.price?.toLocaleString('en-US', {
                                                            style: 'currency',
                                                            currency: 'VND',
                                                        }) : ""}</h5>
                                                    </div>
                                                ...
                                                <div class="summary-list">
                                                    <ul class="list">
                                                        ...
                                                        <li class="d-flex justify-content-between">
                                                            ...
                                                            <span>{rooms && rooms.status ? (rooms.status == "ROOM_RENT" ? "For rent" : "Rented") : ""}</span>
                                                        </li>
                                                        <li class="d-flex justify-content-between">
                                                            <strong>Area</strong>
                                                            <span>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="title-box-d">
                                                        <h3 class="title-d">Post Details</h3>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-10 offset-md-1">
                                    <ul class="nav nav-pills-a nav-pills mb-3 section-t3" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-plans-tab" data-bs-toggle="pill" href="#pills-plans" role="tab" aria-controls="pills-plans" aria-selected="false">Infrastructure</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="property-agent">
                                                ...
                                                <p class="color-text-a">
                                                    The room is always of high quality, exactly as described, with no misleading details to disappoint users when visiting and checking the room. Absolute security.
                                                </p>
                                                    ...
                                                    <ul class="list-inline">
                                                        {rooms && rooms.user?.facebookUrl ?
                                                            <li className="list-inline-item">
                                                                <a href={rooms ? rooms.user?.facebookUrl : ""} className="link-one" target="_blank" rel="noopener noreferrer">
                                                        ...
                                                        {rooms && rooms.user?.zaloUrl ?
                                                            <li className="list-inline-item">
                                                                <a href={rooms ? rooms.user?.zaloUrl : ""} className="link-one" target="_blank" rel="noopener noreferrer">
                                                                    {/* Zalo SVG icon */}
                                ...
                                <div class="col-md-12">
                                    <div class="row section-t3">
                                        <div class="col-sm-12">
                                            <div class="title-box-d">
                                                <h3 class="title-d">Comments & Reviews</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                                ...
                                                {this.props.authenticated ?
                                                    <>
                                                        {showCommentForm ? (
                                                            ...
                                                            <div className="col-md-12 mt-3">
                                                                <button onClick={() => this.setState({ showCommentForm: true })} className="btn btn-a">Add Comment</button>
                                                            </div>
                                                        )}
                                                    </> : "Please log in to comment and review"}
                                            </div>
                                        </div>
                                    </div>
