...
import { followAgents, getAccountById, getAllAccountRentalerForCustomer, getAllRoomByUserId } from "../../services/fetch/ApiUtils";
...
const AgentSingle = (props) => {
    ...
    const fetchData = () => {
        getAllRoomByUserId(currentPage, itemsPerPage, id).then(response => {
                    ...
                    <div class="container">
                        <div class="row">
                                        ...
                                        <div class="agent-info-box">
                                            ...
                                            <div class="agent-content mb-3">
                                                ...
                                                <div className="info-agents color-a">
                                                    <p>
                                                        <strong>Phone: </strong>
                                                        <span className="color-text-a">{rentaler?.phone}</span>
                                                    </p>
                                                    <p>
                                                        <strong>Email: </strong>
                                                        <span className="color-text-a">{rentaler?.email}</span>
                                                    </p>
                                                </div>
                                                <br />
                                                <button type="button" onClick={() => handleFollowAgents()} className="btn btn-outline-success rounded-pill">Follow +</button>
                                            </div>
                                            <div className="socials-footer">
                                                <ul className="list-inline">
                                                    <li className="list-inline-item">
                                                        <a href={rentaler?.zaloUrl} className="link-one" target="_blank" rel="noopener noreferrer">
                                                            <i className="bi bi-facebook" aria-hidden="true"></i>
                                                        </a>
                                                    </li>
                                                    <li className="list-inline-item">
                                                        <a href={rentaler?.facebookUrl} className="link-one" target="_blank" rel="noopener noreferrer">
                            ...
                            <div class="col-md-12 section-t8">
                                <div class="title-box-d">
                                    <h3 class="title-d">My rooms ({totalItems})</h3>
                                </div>
                            </div>
