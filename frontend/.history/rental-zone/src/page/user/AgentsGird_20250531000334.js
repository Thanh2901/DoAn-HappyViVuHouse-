                                        ...
                                        <div className="col-md-6 col-lg-4 mb-4" key={rentaler.id}>
                                            <div
                                                ...
                                                style={{
                                                    ...
                                                    borderRadius: "18px",
                                                    boxShadow: "0 4px 24px 0 rgba(0,0,0,0.10)" // subtle shadow
                                                }}
                                            >
                                                <div className="card-img-top p-0" style={{ textAlign: "center" }}>
                                                    {rentaler?.imageUrl ?
                                                        <img
                                                ...
                                                <div className="card-body" style={{ fontSize: "15px" }}>
                                                    <h5 className="card-title mb-2 text-center fs-4">
                                                        <Link to={`/angent-single/${rentaler.id}`} className="text-decoration-none fw-bold">
                                                            {rentaler.name}
                                                        </Link>
                                                    </h5>
