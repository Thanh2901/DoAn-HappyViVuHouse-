                                    ...
                                    return (
                                        <div className="col-md-6 col-lg-4 mb-4" key={rentaler.id}>
                                            <div
                                                ...
                                                style={{
                                                    background: "linear-gradient(135deg, #f8fafc 60%, #e0e7ff 100%)", // light blue gradient
                                                    borderRadius: "18px"
                                                }}
                                            >
                                                <div className="card-img-top text-center pt-3 p-3">
                                                    {rentaler?.imageUrl ?
                                                ...
                                                <div className="card-body" style={{ fontSize: "15px" }}>
                                                    ...
                                                    <ul className="list-group list-group-flush mb-3">
                                                        <li className="list-group-item d-flex align-items-center border-0 px-0 pb-1" style={{ background: "transparent" }}>
