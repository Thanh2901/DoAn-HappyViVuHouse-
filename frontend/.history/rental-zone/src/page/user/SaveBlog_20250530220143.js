...
function SaveBlog(props) {
    ...
    return (
        <>
                                                    ...
                                                    <div className="col-12">
                                                        <div className="card-body py-3">
                                                            ...
                                                            <Link
                                                                ...
                                                                className="btn btn-success btn-sm mt-2 w-100 fw-bold saveblog-viewdetail-btn"
            ...
            <style>
                {`
                .saveblog-viewdetail-btn {
                    transition: transform 0.15s cubic-bezier(.4,2,.6,1), box-shadow 0.15s;
                }
                .saveblog-viewdetail-btn:hover, .saveblog-viewdetail-btn:focus {
                    transform: translateY(-3px) scale(1.04);
                    box-shadow: 0 6px 24px 0 rgba(40,167,69,0.18), 0 1.5px 6px 0 rgba(40,167,69,0.15);
                    z-index: 2;
                }
                `}
            </style>
