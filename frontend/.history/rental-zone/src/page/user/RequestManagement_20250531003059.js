                ...
                <div className="wrapper">
                    <nav id="sidebar" className="sidebar js-sidebar">
                        <div className="sidebar-content js-simplebar">
                            <a className="sidebar-brand" href="/profile">TENANT SYSTEM</a>
                            <SidebarNav />
                        </div>
                    </nav>
                    ...
                    <div className="main">
                        ...
                        <div className="card">
                            <div className="card-header">
                                ...
                                <h6 className="card-subtitle text-muted"> Manage the status of your requests.</h6>
                            </div>
                            <div className="card-body">
                                <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                    ...
                                    <div className="col-sm-12 col-md-6"><div id="datatables-buttons_filter" className="dataTables_filter float-end">
                                        <label>Search:<input type="search" className="form-control form-control-sm float-end fs-6" placeholder="Name"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th className="sorting" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "180px" }} >Tenant Name</th>
                                                <th className="sorting" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "166px" }} >Phone Number</th>
                                                <th className="sorting" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "130px" }} >Request Description</th>
                                                ...
                                                <tr className="odd">
                                                    ...
                                                    <td>
                                                        <button type="button" className="btn btn-outline-success">
                                                            {item.isAnswer === true ? "Processed" : "Not processed"}
                                                        </button>
                                                    </td>
