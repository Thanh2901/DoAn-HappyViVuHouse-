                ...
                <div className="wrapper">
                    ...
                    <div className="main">
                        ...
                        <div className="card">
                            ...
                            {tableData.map((item) => (
                                        <div className="col-md-4" key={item.rentaler.id}>
                                                        ...
                                                        <div className="socials-footer d-flex justify-content-center">
                                                            <ul className="list-inline">
                                                                <li className="list-inline-item">
                                                                    <a href={item.rentaler?.zaloUrl} className="link-one" target="_blank" rel="noopener noreferrer">
                                                                        <i className="bi bi-facebook" aria-hidden="true"></i>
                                                                    </a>
                                                                </li>
                                                                <li className="list-inline-item">
                                                                    <a href={item.rentaler?.facebookUrl} className="link-one" target="_blank" rel="noopener noreferrer">
