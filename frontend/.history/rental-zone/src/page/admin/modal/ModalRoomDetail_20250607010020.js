                    ...
                    <div className="row">
                            ...
                            <ul className="nav nav-pills-a nav-pills mb-3 section-t3 pt-0" id="pills-tab"
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" id="pills-plans-tab" data-bs-toggle="pill"
                                       href="#pills-plans" role="tab" aria-controls="pills-plans" aria-selected="false">Floor Plan</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" id="pills-map-tab" data-bs-toggle="pill" href="#pills-map"
                                       role="tab" aria-controls="pills-map" aria-selected="false">Address</a>
                                </li>
                            </ul>
                            ...
                            <div className="property-price foo">
                                <div className="card-header-c d-flex">
                                    ...
                                    <div className="card-title-c align-self-center">
                                        <h5 className="title-c">{roomData?.price.toLocaleString('en-US', {
                                            style: 'currency',
                                            currency: 'VND',
                                        })}</h5>
                                    </div>
                                ...
                                <div className="col-md-3 col-sm-6 mb-3">
                                    <div className="property-summary h-100">
                                        <div className="row">
                                            <div className="col-sm-12">
                                                <div className="title-box-d section-t4 pt-0">
                                                    <h3 className="title-d">Assets</h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="summary-list">
                            ...
                            <div className="row section-t3">
                                <div className="col-sm-12">
                                    <div className="title-box-d">
                                        <h3 className="title-d">Contact</h3>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                        ...
                        <div className="col-md-12 my-3">
                            <div className="row section-t3">
                                <div className="col-sm-12">
                                    <div className="title-box-d">
                                        <h3 className="title-d">Comments & Reviews</h3>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
