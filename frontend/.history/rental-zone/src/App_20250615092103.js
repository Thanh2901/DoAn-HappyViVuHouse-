...
import DetailPlayback from "./page/rentaler/DetailPlayback";
import EditRoomAdmin from "./page/admin/EditRoomAdmin";
import FeeConfiguration from './components/FeeConfiguration'; // Điều chỉnh đường dẫn phù hợp
    ...
    <>
      <Router>
        <Routes>
          ...
          />
          <Route
            path="/rentaler/detail-playback/:id"
            element={
              <ProtectedRoute
                authenticated={authenticated}
                role={role}
