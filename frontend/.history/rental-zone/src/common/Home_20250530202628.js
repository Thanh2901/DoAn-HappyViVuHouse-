                    ...
                    <div className="container">
                        <div className="title-wrap d-flex justify-content-between mb-0">
                            <div className="title-box">
                                <h2 className="title-a">Why Choose Happy ViVu House</h2>
                            </div>
                        </div>
                        <div className="services-grid">
                            <div className="service-card">
                                <div className="card-header-c">
                                    ...
                                    <h2 className="title-c">Trusted & Secure</h2>
                                </div>
                            ...
                            <div className="service-card">
                                <div className="card-header-c">
                                    ...
                                    <h2 className="title-c">Affordable Rates</h2>
                                </div>
                                <div className="card-body-c">
                                    <p className="content-c">
                            ...
                            <div className="service-card">
                                <div className="card-header-c">
                                    ...
                                    <h2 className="title-c">Quick & Easy</h2>
                                </div>
                                <div className="card-body-c">
                                    <p className="content-c">
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="title-wrap d-flex justify-content-between">
                                    <div className="title-box">
                                        <h2 className="title-a">Featured Rentals</h2>
                                    </div>
                                            ...
                                            <div className="card-overlay">
                                                <div className="card-overlay-a-content">
                                                    ...
                                                    <div className="card-body-a">
                                                        ...
                                                        <Link to={`/rental-home/${room.id}`} className="color-b">
                                                            View Rental Details
                                                            <span className="bi bi-chevron-right"></span>
                                                        </Link>
                                                    </div>
                                                    <div className="card-footer-a">
                                                        <ul className="card-info d-flex justify-content-around">
                                                            <li>
                                                                ...
                                                                <span>{room.location.cityName}</span>
                                                            </li>
                                                            <li>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <div className="title-wrap d-flex justify-content-between">
                                    <div className="title-box">
                                        <h2 className="title-a">Our Trusted Landlords</h2>
                                    </div>
                                    <div className="title-link">
                                        <a href="/agent-grid">
                                            Meet All Landlords
                                            ...
                                            <div className="card-box-d">
                                                ...
                                                <div className="card-overlay card-overlay-hover">
                                                    ...
                                                    <div className="card-body-d">
                                                        <p className="content-d">{rentaler?.address}</p>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12">
                                <div className="title-wrap d-flex justify-content-between">
                                    <div className="title-box">
                                        <h2 className="title-a">What Our Renters Say</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-sm-12 col-md-6">
                                            ...
                                            <div className="testimonial-author-box">
                                                ...
                                                <h5 className="testimonial-author">Le Kien</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-sm-12 col-md-6">
                                            ...
                                            <div className="testimonial-author-box">
                                                ...
                                                <h5 className="testimonial-author">Tran Hien</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-sm-12 col-md-6">
                                            ...
                                            <div className="testimonial-author-box">
                                                ...
                                                <h5 className="testimonial-author">Ha Linh</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
