                        ...
                        <div className="card-overlay-a-content">
                            ...
                            <div className="card-body-a">
                                <div className="price-box d-flex">
                                    <span className="price-a p-3" style={{ fontSize: '15px', fontWeight: 500 }}>
                                ...
                                <Link to={`/rental-home/${room.id}`} className="color-b" style={{ fontSize: '15px', fontWeight: 500 }}>
                                    View Rental Details
                                    <span className="bi bi-chevron-right"></span>
                                </Link>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="title-wrap d-flex justify-content-between">
                                    ...
                                    <div className="title-link">
                                        <a href="/angent-gird" style={{ fontSize: '1.25rem', fontWeight: 500 }}>
                                            Meet All Landlords
                                            <span className="bi bi-chevron-right"></span>
                                        </a>
                                    </div>
                                ...
                                if (rentaler.roles[0] && rentaler.roles[0].name === "ROLE_RENTALER") {
                                    return (
                                        <div className="col-md-4 mb-4" key={rentaler.id}>
                                            <div className="card h-100 shadow border-0" style={{ borderRadius: "18px", overflow: "hidden" }}>
                                                <div style={{ width: "100%", height: "220px", overflow: "hidden" }}>
                                                    <img
                                                        src={rentaler?.imageUrl ? rentaler.imageUrl : "assets/img/agent-4.jpg"}
                                                        alt={rentaler?.name}
                                                        style={{
                                                            width: "100%",
                                                            height: "100%",
                                                ...
                                                <div className="card-body p-4 d-flex flex-column">
                                                    <h4 className="mb-2 text-center fw-bold" style={{ fontSize: "1.3rem" }}>
                                                        <Link to={`/angent-single/${rentaler.id}`} className="text-decoration-none text-dark">
                                                            {rentaler?.name}
                                                        </Link>
                                                    </h4>
                                                    <div className="mb-2 text-center" style={{ color: "#555" }}>
                                                        <i className="bi bi-geo-alt me-2"></i>
                                                        {rentaler?.address}
                                                    </div>
                                                    <div className="d-flex justify-content-between align-items-center mb-2" style={{ fontSize: "1rem" }}>
                                                        <span>
                                                    ...
                                                    <div className="d-flex justify-content-center gap-2 mt-3">
                                                        {rentaler?.facebookUrl && (
                                                            <a href={rentaler.facebookUrl} className="btn btn-sm btn-outline-primary rounded-3"
                                                        ...
                                                        {rentaler?.zaloUrl && (
                                                            <a href={rentaler.zaloUrl} className="btn btn-sm btn-outline-success rounded-3"
                                                                style={{ width: 38, height: 38, display: "flex", alignItems: "center", justifyContent: "center", padding: 0 }}
