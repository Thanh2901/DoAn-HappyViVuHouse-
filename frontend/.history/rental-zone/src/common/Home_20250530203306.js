                    ...
                    <div className="container">
                        <div className="title-wrap d-flex justify-content-between mb-0">
                            <div className="title-box">
                                <h2 className="title-a" style={{ fontSize: '1.5rem', fontWeight: 600, lineHeight: 1.3 }}>
                                    Why Choose Happy ViVu House
                                </h2>
                            </div>
                        </div>
                        <div className="services-grid">
                            <div className="service-card">
                                <div className="card-header-c">
                                    ...
                                    <h2 className="title-c" style={{ fontSize: '1rem', fontWeight: 500, lineHeight: 1.4 }}>
                                        Trusted & Secure
                                    </h2>
                                </div>
                                <div className="card-body-c">
                                    <p className="content-c" style={{ fontSize: '0.75rem', lineHeight: 1.6, color: '#555' }}>
                            ...
                            <div className="col-md-12">
                                <div className="title-wrap d-flex justify-content-between">
                                    ...
                                    <div className="title-link">
                                        <a href="/rental-home" style={{ fontSize: '0.75rem', fontWeight: 500 }}>
                                            Explore All Rentals
                                            ...
                                            <div className="card-overlay">
                                                <div className="card-overlay-a-content">
                                                    <div className="card-header-a">
                                                        <h2 className="card-title-a" style={{ fontSize: '1rem', fontWeight: 500, lineHeight: 1.4 }}>
                                                            <Link to={`/rental-home/${room.id}`}>
                                                                <b style={{ fontSize: '1rem' }}>{room.title}</b>
                                                                <br />
                                                                <small style={{ fontSize: '0.625rem', color: '#777' }}>{room.description}</small>
                                                            </Link>
                                                        </h2>
                                                    </div>
                                                    <div className="card-body-a">
                                                        <div className="price-box d-flex">
                                                            <span className="price-a" style={{ fontSize: '0.875rem', fontWeight: 500 }}>
                                                        ...
                                                        <Link to={`/rental-home/${room.id}`} className="color-b" style={{ fontSize: '0.75rem', fontWeight: 500 }}>
                                                            View Rental Details
                                                            <span className="bi bi-chevron-right"></span>
                                                        </Link>
                                                    </div>
                                                    <div className="card-footer-a">
                                                        <ul className="card-info d-flex justify-content-around">
                                                            <li>
                                                                <h4 className="card-info-title" style={{ fontSize: '0.625rem', fontWeight: 500, color: '#666' }}>
                                                                    Location
                                                                </h4>
                                                                <span style={{ fontSize: '0.625rem', fontWeight: 400 }}>{room.location.cityName}</span>
                                                            </li>
                                                            <li>
                                                                <h4 className="card-info-title" style={{ fontSize: '0.625rem', fontWeight: 500, color: '#666' }}>
                                                                    Type
                                                                </h4>
                                                                <span style={{ fontSize: '0.625rem', fontWeight: 400 }}>{room.category.name}</span>
                                                            </li>
                                                            <li>
                                                                <h4 className="card-info-title" style={{ fontSize: '0.625rem', fontWeight: 500, color: '#666' }}>
                                                                    Landlord
                                                                </h4>
                                                                <span style={{ fontSize: '0.625rem', fontWeight: 400 }}>{room.user.name}</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                <div className="title-wrap d-flex justify-content-between">
                                    ...
                                    <div className="title-link">
                                        <a href="/agent-grid" style={{ fontSize: '0.75rem', fontWeight: 500 }}>
                                            Meet All Landlords
                                            <span className="bi bi-chevron-right"></span>
                                        </a>
                                    </div>
                                                ...
                                                <div className="card-overlay card-overlay-hover">
                                                    <div className="card-header-d">
                                                        <div className="card-title-d align-self-center">
                                                            <h3 className="title-d" style={{ fontSize: '1rem', fontWeight: 500, lineHeight: 1.4 }}>
                                                    ...
                                                    <div className="card-body-d">
                                                        <p className="content-d" style={{ fontSize: '0.75rem', lineHeight: 1.6 }}>
                                                            {rentaler?.address}
                                                        </p>
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-sm-12 col-md-6">
                                            ...
                                            <div className="testimonials-content">
                                                <p className="testimonial-text" style={{ fontSize: '0.75rem', lineHeight: 1.6, fontStyle: 'italic' }}>
                                            ...
                                            <div className="testimonial-author-box">
                                                ...
                                                <h5 className="testimonial-author" style={{ fontSize: '0.75rem', fontWeight: 500 }}>
                                                    Le Kien
                                                </h5>
                                            </div>
                                        </div>
