                                        ...
                                        <div className="col-md-4 mb-4" key={rentaler.id}>
                                            <div className="card h-100 shadow border-0" style={{ borderRadius: "18px", overflow: "hidden" }}>
                                                ...
                                                <div className="card-body p-4 d-flex flex-column align-items-center">
                                                    <h4 className="mb-2 fw-bold text-center" style={{ fontSize: "1.3rem" }}>
                                                        <Link to={`/agent-single/${rentaler.id}`} className="text-decoration-none text-dark">
                                                            {rentaler?.name}
                                                        </Link>
                                                    </h4>
                                                    <div className="mb-3 text-center" style={{ color: "#555", fontSize: "1rem" }}>
                                                    ...
                                                    <div className="w-100 mb-3">
                                                        <div className="d-flex justify-content-center align-items-center gap-3 flex-wrap">
                                                            <span style={{ minWidth: 120 }}>
                                                                ...
                                                                <span style={{ fontWeight: 500 }}>Phone:</span> {rentaler?.phone}
                                                            </span>
                                                            <span style={{ minWidth: 120 }}>
                                                                <i className="bi bi-envelope me-1"></i>
                                                                <span style={{ fontWeight: 500 }}>Email:</span> {rentaler?.email}
                                                            </span>
                                                        </div>
                                                    </div>
