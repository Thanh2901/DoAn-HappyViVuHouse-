...
import "./Home.css"; // File CSS riêng
...
class Home extends Component {
    ...
    render() {
        ...
        const settings = {
            dots: false, // Ẩn chấm pagination (theo yêu cầu trước đó)
            infinite: true, // Vòng lặp vô hạn
            speed: 500, // Tốc độ chuyển slide (ms)
            slidesToShow: 1, // Hiển thị 1 slide
            slidesToScroll: 1, // Chuyển 1 slide mỗi lần
            autoplay: true, // Tự động chuyển slide
            autoplaySpeed: 5000, // Thời gian chờ giữa các slide (ms), tương ứng với delay của Swiper
            arrows: true, // Hiển thị nút điều hướng (navigation)
                                                        ...
                                                        <div className="price-box d-flex">
                                                            <span className="price-a">
                                                                {room.status === "ROOM_RENT" &&
                                                                    `Cho thuê | ${room.price.toLocaleString("vi-VN", {
                                                                        style: "currency",
                                                                        currency: "VND",
                                                                    })}`}
                                                                {room.status === "HIRED" &&
                                                                    `Đã thuê | ${room.price.toLocaleString("vi-VN", {
                                                                        style: "currency",
                                                                        currency: "VND",
                                                                    })}`}
                                                                {room.status === "CHECKED_OUT" &&
                                                                    `Đã trả phòng | ${room.price.toLocaleString("vi-VN", {
                                                                        style: "currency",
                                                                        currency: "VND",
                                                                    })}`}
                                                            </span>
