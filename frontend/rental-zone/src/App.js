        ...
        <>
            <Router>
                <Routes>
                    ...
                    <Route exact path="/login" element={<Login authenticated={authenticated} setAuthenticated={setAuthenticated} setRole={setRole} setCurrentUser={setCurrentUser} setUsername={setUsername} />} />
                    <Route exact path="/login-rentaler" element={<LoginRentaler authenticated={authenticated} currentUser={currentUser} role={role} setAuthenticated={setAuthenticated} setRole={setRole} setCurrentUser={setCurrentUser} setUsername={setUsername} />} />
                    <Route exact path="/login-admin" element={<LoginAdmin authenticated={authenticated} currentUser={currentUser} role={role} setAuthenticated={setAuthenticated} setRole={setRole} setCurrentUser={setCurrentUser} setUsername={setUsername} />} />
                    ...
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_ADMIN">
                                <DashboardAdmin authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_ADMIN">
                                <RoomManagementAdmin authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_ADMIN">
                                <Authorization authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_ADMIN">
                                <AccountManagement authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_ADMIN">
                                <SendEmail authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    ...
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <ChangePassword authenticated={authenticated} exit={exitLogoutChangePassword} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <ProfileRentaler authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <DashboardRentaler authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <Chat authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <AddRoom authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <EditRoom authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <AddContract authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <AddElectricAndWater authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <EditContract authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <AddMaintence authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <EditMaintenance authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <ContractManagement authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <RoomManagement authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <MaintenceManagement authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <RequierManagement authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <ExportBillRequier authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <ExportCheckoutRoom authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <ElectricAndWaterManagement authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
                    <Route
                        ...
                        element={
                            <ProtectedRoute authenticated={authenticated} role={role} allowedRole="ROLE_RENTALER">
                                <EditElectricAndWater authenticated={authenticated} currentUser={currentUser} role={role} onLogout={handleLogout} />
                            </ProtectedRoute>
                        }
                    />
