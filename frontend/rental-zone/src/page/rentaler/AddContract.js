                    ...
                    <div className="container-fluid p-0">
                        <div className="card">
                            <div className="card-header">
                                <h5 className="card-title fs-5">Thiết lập hợp đồng</h5>
                            </div>
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    {/* Contract Information Section */}
                                    <div className="form-section border">
                                        <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Thông tin hợp đồng</h6>
                                        <div className="row">
                                            <div className="mb-3 col-md-6 col-sm-12">
                                                <label className="form-label" htmlFor="name">Tên hợp đồng</label>
                                                <input
                                                    type="text"
                                            ...
                                            <div className="mb-3 col-md-6 col-sm-12">
                                                <label className="form-label" htmlFor="roomId">Chọn phòng</label>
                                                <select
                                        ...
                                        <div className="row">
                                            <div className="mb-3 col-md-6 col-sm-12">
                                                <label className="form-label" htmlFor="deadline">Thời hạn hợp đồng</label>
                                                <input
                                                    type="datetime-local"
                                            ...
                                            <div className="mb-3 col-md-6 col-sm-12">
                                                <label className="form-label" htmlFor="numOfPeople">Số lượng người</label>
                                                <input
                                                    type="number"
                                    ...
                                    <div className="form-section border">
                                        <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Thông tin người thuê</h6>
                                        <div className="row">
                                            <div className="mb-3 col-md-6 col-sm-12">
                                                <label className="form-label" htmlFor="searchName">Tìm người thuê</label>
                                            ...
                                            <div className="mb-3 col-md-6 col-sm-12">
                                                <label className="form-label" htmlFor="nameRentHome">Người thuê</label>
                                                <input
                                                    type="text"
                                                    className="form-control"
                                                    id="nameRentHome"
                                    ...
                                    {/* File Upload Section */}
                                    <div className="form-section border">
                                        <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Tài liệu hợp đồng</h6>
                                        <div className="mb-3">
                                            <label className="form-label">Tải file hợp đồng (PDF)</label>
