                ...
                <div className="main">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="card-title fs-5">Quản lý bảo trì</h5>
                                    ...
                                    <tbody>
                                        {tableData.map((item) => (
                                            <tr className="odd">
                                                ...
                                                <td>
                                                    <a href="#" onClick={() => handleEditMaintenance(item.id)} data-toggle="tooltip" tabindex="0" data-placement="bottom" title="Sửa" className="mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 align-middle"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
                                                    &nbsp;
                                                    <a href="#" onClick={() => handleDeleteMaintenance(item.id)} data-toggle="tooltip" tabindex="0" data-placement="bottom" title="Xóa" className="mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash align-middle"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></a>
                                                </td>
