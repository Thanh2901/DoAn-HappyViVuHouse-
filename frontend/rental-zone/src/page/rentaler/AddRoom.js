                    ...
                    <div className="container-fluid p-0">
                        <div className="card">
                            <div className="card-header">
                                <h5 className="card-title fs-5">Thêm phòng trọ</h5>
                            </div>
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    {/* Basic Information Section */}
                                    <div className="form-section border">
                                        <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Thông tin cơ bản</h6>
                                        <div className="row">
                                    ...
                                    <div className="form-section border">
                                        <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Chi phí</h6>
                                        <div className="row">
                                            <div className="mb-3 col-md-4 col-sm-6">
                                                <label className="form-label" htmlFor="price">Giá thuê</label>
                                                <input
                                                    type="number"
                                    ...
                                    <div className="form-section border">
                                        <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Thông tin vị trí</h6>
                                        <div className="row">
                                            <div className="mb-3 col-md-4 col-sm-6">
                                    ...
                                    {/* File Upload Section */}
                                    <div className="form-section border">
                                        <h6 className="text-capitalize fw-semibold bg-light py-2 rounded-2 mb-3">Hình ảnh</h6>
                                        <div className="mb-3">
