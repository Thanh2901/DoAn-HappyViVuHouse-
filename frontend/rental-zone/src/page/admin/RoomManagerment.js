                ...
                <div className="main">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="card-title fs-5">Quản lý phòng trọ và bài đăng</h5>
                                ...
                                {tableData.map((item) => (
                                    <tr className="odd">
                                        ...
                                        <td style={{ color: "green" }}>
                                            <button type="button" className="btn btn-outline-success" onClick={() => handleIsApprove(item.id)}>
                                                {(item.isApprove === false) || (item.isApprove === "false") ? "Duyệt" : "Đã duyệt"}
                                            </button>
                                        </td>
                                        <td style={{ color: "green" }}>
                                            <button type="button" className="btn btn-outline-danger" onClick={() => handleIsRemove(item.id)}>
                        ...
                        <div className="modal-dialog modal-xl">
                            <div className="modal-content">
                                <div className="modal-header">
                                    <h5 className="modal-title" id="exampleModalLabel">Chi tiết bài đăng tin</h5>
