...
template = """
Chỉ trả lời thông tin phòng trọ phù hợp với câu hỏi dưới đây.
...
Nếu có, liệt kê các phòng đó với định dạng rõ ràng, không cần chào hỏi, không giới thiệu bản thân.
"""
