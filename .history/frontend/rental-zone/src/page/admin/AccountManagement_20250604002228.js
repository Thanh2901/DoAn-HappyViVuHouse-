                ...
                <div className="main">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="card-title fs-5">Account Management</h5>
                            <h6 className="card-subtitle text-muted">Account management includes role assignment and account locking features.</h6>
                        </div>
                        <div className="card-body">
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                ...
                                <div className="col-sm-12 col-md-6"><div id="datatables-buttons_filter" className="dataTables_filter float-end mb-3">
                                    <label>Search:<input type="search" className="form-control form-control-sm float-end fs-6" placeholder="Enter name or email"
                                ...
                                <thead>
                                <tr>
                                    <th className="sorting sorting_asc" tabIndex="0" aria-controls="datatables-buttons" rowSpan="1" colSpan="1" style={{ width: "224px" }}  >Full Name</th>
                                    <th className="sorting" tabIndex="0" aria-controls="datatables-buttons" rowSpan="1" colSpan="1" style={{ width: "290px" }} >Email</th>
                                    <th className="sorting" tabIndex="0" aria-controls="datatables-buttons" rowSpan="1" colSpan="1" style={{ width: "166px" }} >Phone Number</th>
                                ...
                                {tableData.map((item) => (
                                    <tr className="odd">
                                        ...
                                        <td style={{ color: "green" }}>
                                            <button type="button" className="btn btn-outline-success" onClick={() => handleLockedAccount(item.id)}>
                                                {item.isLocked === true ? "Unlock" : "Lock"}
                                            </button>
                                        </td>
                                        <td>
                                            <button type="button" className="btn btn-success" onClick={() => handleAuthorization(item.id)}>
                                                Assign Role
                                            </button>
                                        </td>
                                    </tr>
