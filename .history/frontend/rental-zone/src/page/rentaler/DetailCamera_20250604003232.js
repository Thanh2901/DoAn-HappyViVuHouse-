                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <div className="row mb-4">
                      <div className="col-12 d-flex justify-content-center align-items-center" style={{ minHeight: 180 }}>
                        <form
                          className="d-flex flex-wrap gap-4 align-items-end"
                          style={{
                            background: "#f8f9fa",
                            borderRadius: 10,
                            padding: 20,
                        ...
                        >
                          <div className="mb-3" style={{ minWidth: 180 }}>
                            <label className="form-label fw-bold">Camera name</label>
                            <input
                              type="text"
                          ...
                          <div className="mb-3" style={{ minWidth: 100 }}>
                          ...
                          <div className="mb-3" style={{ minWidth: 120 }}>
                            ...
                            <div>
                              <span className={`badge fs-6 ${status === true ? "bg-success" : "bg-danger"}`}>
