                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="row">
                                        <div className="mb-3">
                                            <label className="form-label">{translate("rentaler:maintenance_management:uploadTicket")}</label>
                                            <input className="form-control" type="file" accept=".pdf" name="files" multiple onChange={handleFileChange} />
                                        </div>
                                    </div>
                                    <button type="submit" className="btn btn-primary">{translate("rentaler:maintenance_management:submit")}</button>
                                </form>
                            </div>
                        </div>
                    </div>
